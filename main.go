...
func init() {
	...
	fenixTestDataSyncServer_address_to_dial = common_config.FenixTestDataSyncServerAddress + ":" + strconv.Itoa(common_config.FenixTestDataSyncServerPort)
